...
//  Snake
//
//  Created by Seth VanBrocklin on 3/8/19.
...
class GameScene: SKScene {
    ...
    private func initializeGameView() {
        ...
        let height = frame.size.height - 235
        let rect = CGRect(x: -width / 2, y: -520 , width: width, height: height)
